...
<body>
	...
	<div class="container">
		<div class="row contaniner-fluid">
			<div class="col text-start">${boardDetail.BTITLE}</div>
			<div class="col d-flex justify-content-end text-end">
				<ul class="list-group list-group-horizontal">
					<li class="list-group-item border-0 p-1">${boardDetail.MID}</li>
					<li class="list-group-item border-0 p-1">${boardDetail.BOARDHIT}조회</li>
					<li class="list-group-item border-0 p-1">${boardDetail.BOARDLIKE}좋아요</li>
					<li class="list-group-item border-0 p-1">${fn:substring(boardDetail.BDATE,2,16)}</li>

				</ul>
			</div>
		</div>
		<div class="form-group">
			<label for="content" class="col-sm-2 control-label">${boardDetail.BCONTENT}</label>
			<br />
			<br />
			<br />
			<br />
		...
		<div class="row container-fluid">
			<div class="d-flex justify-content-center">
				...
				<div class="col-1">
					...
					신고
					<c:if test="${sessionScope.loginInfo.getMLEVEL() == 0}"></c:if>
		...
		<div
			...
			<div class="col-3 d-flex justify-content-end">
				<ul class="list-group list-group-horizontal">
					...
					<li class="list-group-item border-0 p-1">${fn:substring(i.getCMDATE(),2,16)}</li>				
				</ul>
			</div>
		</div>
		</c:forEach>
